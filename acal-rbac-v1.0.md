...
- A **`permit-unless-deny` combining algorithm** on a Role Policy, a Permission Policy, or the entry point ([Section 5.3](#53-access-control) forbids it) turns "no permission applied" into `Permit`.
