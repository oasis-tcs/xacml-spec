...
Edited by Steven Legg and Cyril Dangerville. 20 December 2025. OASIS Committee Specification Draft 01.
...
Run the following command line to generate HTML from this markdown file (named `acal-v1.0-xpath.md`), :
...
```console
$ pandoc -f gfm+definition_lists -t pdf acal-v1.0-xpath.md -c styles/markdown-styles-v1.7.3a.css \
         -H custom_latex_header_for_pandoc_pdf_output.tex -s -L diagram.lua \
         --metadata title="ACAL v1.0 XPath Profile Version 1.0" --embed-resources \
         -o acal-v1.0-xpath.pdf 
```
