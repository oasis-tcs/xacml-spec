...
* XML schema:  https://docs.oasis-open.org/xacml/xacml/v4.0/csd01/schema/xacml-core-v3-schema-wd-17.xsd.  (probably a different filename)
...
* list namespaces declared within this document (hyperlink if HTTP-based). Delete section if there are no namespaces.
* http://docs.oasis-open.org/xacml/ns/example
...
Edited by Steven Legg. 13 June 2024. OASIS Committee Specification Draft 01.
https://docs.oasis-open.org/xacml/xacml/v4.0/csd01/xacml-v4.0-csd01.html.
...
- The text in the Reference tag (following ###### ) will become an HTML anchor using the following conversion rules:  
  ...
  - this is often referred to as "kebab case"
...
<!-- Required section. Should be placed as the last major section before the Appendices. -->
