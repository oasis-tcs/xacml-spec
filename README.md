...
### How do I validate XACML documents with the XACML schemas (when my implementation supports XML Schema v1.1)?
...
### If my implementation does not support the XML Schema v1.1 standard, how do I validate XACML documents with the XACML schemas (XSD v1.0 and Schematron)?
